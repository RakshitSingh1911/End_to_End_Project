...
class ModelTrainer:
    ...
    def best_train_model(self,x_train,y_train,x_test,y_test):
        # try:
        ...
        try:
            ...
            model_report:dict=utils.evaluate_model(x_train,y_train,x_test,y_test,models)
            print(model_report)
            print('\n====================================================================================\n')
    ...
    def initiate_model_trainer(self,)->artifact_entity.ModelTrainerArtifact:
        try:
            ...
            model = self.best_train_model(x_train,y_train,x_test,y_test)
